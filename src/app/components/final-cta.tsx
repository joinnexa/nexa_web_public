...
export function FinalCTA({ isDark = false }: FinalCTAProps) {
  ...
  return (
    <section id="waitlist" className="px-4 sm:px-6 lg:px-12 py-12 sm:py-16 lg:py-28">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 pt-4 sm:pt-8">
            <a
              href="mailto:contact@joinnexa.ma?subject=Join%20Nexa%20Waitlist"
              className={`
                w-full sm:w-auto text-center px-6 sm:px-10 py-3 sm:py-5 rounded-full font-semibold text-base sm:text-lg transition-all
                ${isDark
